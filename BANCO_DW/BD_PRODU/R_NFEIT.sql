...
ALTER TABLE [dbo].[R_NFEIT]  WITH NOCHECK ADD  CONSTRAINT [FK_R_NFEIT_R_PRODU] FOREIGN KEY([Cod_Produto])
...
ALTER TABLE [dbo].[R_NFEIT] CHECK CONSTRAINT [FK_R_NFEIT_R_PRODU]
GO
