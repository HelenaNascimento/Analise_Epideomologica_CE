...
ALTER TABLE [dbo].[R_NFSIT]  WITH NOCHECK ADD  CONSTRAINT [FK_R_NFSIT_NFSCB] FOREIGN KEY([Cod_Estabe], [Ser_Nota], [Num_Nota])
REFERENCES [dbo].[NFSCB] ([Cod_Estabe], [Ser_Nota], [Num_Nota])
ON UPDATE CASCADE
ON DELETE CASCADE
NOT FOR REPLICATION 
GO

ALTER TABLE [dbo].[R_NFSIT] CHECK CONSTRAINT [FK_R_NFSIT_NFSCB]
GO

ALTER TABLE [dbo].[R_NFSIT]  WITH NOCHECK ADD  CONSTRAINT [FK_R_NFSIT_PRODU] FOREIGN KEY([Cod_Produto])
...
ALTER TABLE [dbo].[R_NFSIT] CHECK CONSTRAINT [FK_R_NFSIT_PRODU]
GO
