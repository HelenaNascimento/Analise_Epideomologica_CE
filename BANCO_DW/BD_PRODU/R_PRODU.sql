...
ALTER TABLE [dbo].[R_PRODU]  WITH NOCHECK ADD  CONSTRAINT [FK_R_PRODU_CLASS] FOREIGN KEY([Cod_Classif])
REFERENCES [dbo].[CLASS] ([Codigo])
GO

ALTER TABLE [dbo].[R_PRODU] CHECK CONSTRAINT [FK_R_PRODU_CLASS]
GO
