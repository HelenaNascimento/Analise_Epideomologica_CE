...
/****** Object:  View [dbo].[VW_TIMESTRAL_VXVENDEDOR]    Script Date: 13/04/2024 16:59:29 ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[VW_TIMESTRAL_VXVENDEDOR] AS
			SELECT 
			DISTINCT
			...
			FROM PROD_2023.dbo.NFSCB cb 
				...
				left join PROD_2023.dbo.VENDE VE on cb.Cod_Vendedor = VE.Codigo
